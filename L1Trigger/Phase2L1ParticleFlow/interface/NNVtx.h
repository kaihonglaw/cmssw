...
public:
  ...
  //bool TTTrackNetworkSelector(const l1ct::TkObjEmu& t, const l1ct::PVObjEmu& v);
  //bool TTTrackNetworkSelector_PFChargedObjEmu(const l1ct::PFChargedObjEmu& t, const l1ct::PVObjEmu& v);
