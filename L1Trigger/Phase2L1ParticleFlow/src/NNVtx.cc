...
bool NNVtx::TTTrackNetworkSelector(const l1ct::TkObjEmu& t, const l1ct::PVObjEmu& v){
...
bool NNVtx::TTTrackNetworkSelector_PFChargedObjEmu(const l1ct::PFChargedObjEmu& t, const l1ct::PVObjEmu& v){
  tensorflow::Tensor inputAssoc(tensorflow::DT_FLOAT, {1, 4});
      std::vector<tensorflow::Tensor> outputAssoc;
